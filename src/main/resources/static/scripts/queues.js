export function init() {
    ...
    document.body.addEventListener("submit", async (event) => {
        ...
        const isAdd = form.classList.contains("queue-program-form");
        const isEditOrDelete = submitter.classList.contains("queue-edit-btn") ||
            submitter.classList.contains("queue-delete-btn");
    ...
    document.body.addEventListener("click", async (event) => {
        ...
        if (membersTextarea) {
            ...
            if (membersText && !formData.has("members")) {
                formData.append("members", membersText);
            }
        }
    ...
    if (textarea && counter) {
        textarea.addEventListener("input", () => {
            ...
            counter.textContent = `${numbers.length} members added`;
        });
    }
}
